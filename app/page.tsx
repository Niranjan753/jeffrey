    ...
    <div className="min-h-screen lg:h-screen w-full bg-[#fbfbfb] overflow-x-hidden relative font-[family-name:var(--font-geist-sans)] flex flex-col">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 lg:px-10 py-4 lg:py-8 shrink-0">
        ...
        <div className="flex gap-2 lg:gap-6 items-center">
          <Link href="/dashboard">
            <Button variant="ghost" className="font-bold text-gray-600 hover:text-blue-600 hover:bg-white border border-transparent hover:border-gray-200 hover:shadow-sm transition-all rounded-xl px-6">
              Log in
            </Button>
          </Link>
          <Link href="/dashboard">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl px-6 shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] transition-all">
              Play Now
            </Button>
          </Link>
        </div>
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            <div className="flex flex-col items-start space-y-8">
              <Link href="/dashboard" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white text-xl font-bold rounded-2xl h-16 px-10 shadow-[0_8px_30px_rgb(37,99,235,0.4)] border-b-4 border-blue-800 active:border-b-0 active:translate-y-1 transition-all">
                  START PLAYING!
                </Button>
              </Link>
...
function MiniFeature({ icon, text }: { icon: React.ReactNode, text: string }) {
  return (
    <div className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all cursor-default">
