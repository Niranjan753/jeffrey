...
export const WordSlot = ({ letter, isFilled }: WordSlotProps) => {
  return (
    <div
      className={cn(
        "relative w-20 h-20 lg:w-24 lg:h-24 border-4 rounded-2xl lg:rounded-3xl flex items-center justify-center text-4xl lg:text-5xl font-black transition-all duration-300 ease-out will-change-transform",
        isFilled 
